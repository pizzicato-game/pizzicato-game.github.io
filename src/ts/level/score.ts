import { correctTargetId, earlyTargetId, lateTargetId, missedTargetId, skippedTargetId } from '../core/config'
...
export class Score {
  ...
  private addHit(target: Target, playerSongTime: number, classification: string) {
