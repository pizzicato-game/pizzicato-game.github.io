...
export default class MainMenu extends HandScene {
  ...
  async preload() {
    ...
    this.load.image(menuSelectButtonTextureKey, absPath(menuSelectButtonTexturePath))
    this.load.image(menuCalibrateButtonTextureKey, absPath(menuCalibrateButtonTexturePath))
  ...
  create() {
    ...
    this.menuCalibrate = new Button(
      this,
      new Vector2(horizontalCenter - windowWidth * mainMenuButtonGap, mainMenubuttonTopLevel * windowHeight),
      standardButtonScale,
      menuCalibrateButtonTextureKey,
      buttonPinchSoundKey,
      true
    ...
    this.menuLogo = this.add.sprite(0, 0, logoTextureKey).setOrigin(0, 0).setScale(0.7, 0.7)
    this.menuLogo.setPosition(horizontalCenter - this.menuLogo.displayWidth / 2, 0.25 * windowHeight)
